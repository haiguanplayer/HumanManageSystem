...
<html>
  ...
  <body>
 	 <form action = "emp_insertDept.action" method="post">
		...
		<tr>
			<td>之前部门</td>
			<td>
				<input name = "before_dept" type="text" value="${z.dept_name }">
			</td>
		<tr>
		<tr>
			<td>现在部门</td>
			<td>
				<input name = "after_dept" type="text" value="${u.dept_name }">
			</td>
		<tr>
		<tr>
			<td>调转类型</td>
			<td>
				<select name="move_dept_class" style="width: 156px; height: 30px">
		...
		<tr>
			<td>调转原因</td>
			<td>
				<input name = "move_dept_reason" type="text">
			</td>
		<tr>
		<tr>
			<td>调转日期</td>
			<td>
				<input name = "move_dept_date" type="date">
			</td>
		<tr>
		<tr>
			<td>
